...
function autoCorrectParams(memory) {
  ...
  if (dp.minEventsPerTicket < 4)  { dp.minEventsPerTicket = 4;  corrections.push("minEvents trop bas → 4 (range 30-400)"); }
  if (dp.minEventsPerTicket > 8)  { dp.minEventsPerTicket = 5;  corrections.push("minEvents trop haut → 5 (range 30-400)"); }
