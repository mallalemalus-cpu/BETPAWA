...
// Simulation de la détection RLM basée sur la structure des cotes
// (Sans accès aux données de % de paris publics, on utilise des heuristiques)
...
function analyzeMatchSharp(match, homeFormData, awayFormData) {
  ...
  if (result.rlm && result.rlm.rlmSignal) summaryParts.push("⚡ RLM: "+result.rlm.note);
